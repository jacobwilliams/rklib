...
!  Verner's "Maple" (dverk78
    ...
    real(wp),parameter :: a12 = 1
    real(wp),parameter :: a13 = 1
    ...
    real(wp),parameter :: b1311 = 0
    real(wp),parameter :: b1312 = 0
    ...
    call me%f(t+a9*h,x+h*(b91*f1+b92*f2+b93*f3+b94*f4+b95*f5+b96*f6+b97*f7+&
                          b98*f8),f9)
    ...
    call me%f(t+a13*h,x+h*(b131*f1+b132*f2+b133*f3+b134*f4+b135*f5+b136*f6+&
                          b137*f7+b138*f8+b139*f9+b1310*f10+b1311*f11+b1312*f12),f13)

    xf = x+h*(c1*f1+c2*f2+c3*f3+c4*f4+c5*f5+c6*f6+c7*f7+c8*f8+c9*f9+c10*f10+c11*f11+c12*f12+c13*f13)

    terr = h*(e1*f1+e2*f2+e3*f3+e4*f4+e5*f5+e6*f6+e7*f7+e8*f8+e9*f9+e10*f10+e11*f11+e12*f12+e13*f13)
...
!    [Coefficients](http://www.peterstone.name/Maplepgs/Maple/nmthds/RKcoeff/Runge_Kutta_schemes/RK10/RKcoeff10c_1.pdf)
    ...
    terr = h*(e1*f1+e12*f12+e13*f13+e14*f14+e15*f15+e16*f16+&
...
!  * [Coefficients](http://www.peterstone.name/Maplepgs/Maple/nmthds/RKcoeff/Runge_Kutta_schemes/RK11/RKcoeff11_a.pdf)
    ...
    terr = h*(e1*f1+e2*f2+e3*f3+e4*f4+e5*f5+e6*f6+e7*f7+e8*f8+e9*f9+e10*f10+e11*f11+e12*f12+&

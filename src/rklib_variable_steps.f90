...
!*****************************************************************************************
!>
!  Papakostas-PapaGeorgiou 5(4) method.
!
!### Reference
...
!@note The floating point coefficients here were generated from the rational ones from the 2nd reference.
    ...
    real(wp),parameter :: b1614 = 0
    real(wp),parameter :: b1615 = 0
    ...
    call me%f(t+a10*h,x+h*(b101*f1+b102*f2+b103*f3+b104*f4+b105*f5+b106*f6+b107*f7+b108*f8+b109*f9),f10)
    call me%f(t+a11*h,x+h*(b111*f1+b112*f2+b113*f3+b114*f4+b115*f5+b116*f6+b117*f7+b118*f8+b119*f9+&
                           b1110*f10),f11)
    call me%f(t+a12*h,x+h*(b121*f1+b122*f2+b123*f3+b124*f4+b125*f5+b126*f6+b127*f7+b128*f8+b129*f9+&
                           b1210*f10+b1211*f11),f12)
    call me%f(t+a13*h,x+h*(b131*f1+b132*f2+b133*f3+b134*f4+b135*f5+b136*f6+b137*f7+b138*f8+b139*f9+&
                           b1310*f10+b1311*f11+b1312*f12),f13)
    call me%f(t+a14*h,x+h*(b141*f1+b142*f2+b143*f3+b144*f4+b145*f5+b146*f6+b147*f7+b148*f8+b149*f9+&
                           b1410*f10+b1411*f11+b1412*f12+b1413*f13),f14)
    call me%f(t+h,    x+h*(b151*f1+b152*f2+b153*f3+b154*f4+b155*f5+b156*f6+b157*f7+b158*f8+b159*f9+&
                           b1510*f10+b1511*f11+b1512*f12+b1513*f13+b1514*f14),f15)
    call me%f(t+h,    x+h*(b161*f1+b162*f2+b163*f3+b164*f4+b165*f5+b166*f6+b167*f7+b168*f8+b169*f9+&
                           b1610*f10+b1611*f11+b1612*f12+b1613*f13+b1614*f14+b1615*f15),f16)

    xf = x+h*(c1*f1+c2*f2+c3*f3+c4*f4+c5*f5+c6*f6+c7*f7+c8*f8+c9*f9+c10*f10+c11*f11+c12*f12+c13*f13+c14*f14+c15*f15+c16*f16)

    xerr = h*(e1*f1+e2*f2+e3*f3+e4*f4+e5*f5+e6*f6+e7*f7+e8*f8+e9*f9+e10*f10+e11*f11+e12*f12+e13*f13+e14*f14+e15*f15+e16*f16)
